...
public class BoxDrawingView extends View {
    ...
    private static final String KEY_SAVE_BOXES = "key_save_boxes";
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        if(state instanceof Bundle) {
            ...
            mBoxes = (ArrayList<Box>) bundle.getSerializable(KEY_SAVE_BOXES);
            if(mBoxes.isEmpty()){
                Log.i(TAG, "mBoxes is empty");
            }else{
                Log.i(TAG, "mBoxes is not empty");
            }
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        bundle.putSerializable(KEY_SAVE_BOXES, mBoxes);
